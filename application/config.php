...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => '@tT>hN94?`G-s)I(Rf.PgLeAOErl3*~"x!HJiS,q', //默认数据加密KEY
	'data_cache_key'=> '@tT>hN94?`G-s)I(Rf.PgLeAOErl3*~"x!HJiS,q',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'@tT>hN94?`G-s)I(Rf.PgLeAOErl3*~"x!HJiS,q', //加密KEY
