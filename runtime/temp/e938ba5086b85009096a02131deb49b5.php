<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"D:\PhPstudy\WWW\think2\public/../application/admin/view/default/center\index.html";i:1511967259;s:80:"D:\PhPstudy\WWW\think2\public/../application/admin/view/default/public\base.html";i:1511937525;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <tbody>
		...
		<tr>
			...
			<td>
				<a class="btn static" href="javascript: ;" id="<?php echo $vo['id']; ?>" static="<?php echo $vo['static']; ?>">
					<?php switch($vo['static']): case "0": ?>
					 待处理
					<?php break; case "1": ?>
					 处理中
					<?php break; case "-1": ?>
