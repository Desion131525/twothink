<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"D:\PhPstudy\WWW\think2\public/../application/admin/view/default/center\approve.html";i:1512025088;s:80:"D:\PhPstudy\WWW\think2\public/../application/admin/view/default/public\base.html";i:1511937525;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<div class="cf">
		<div class="fl">
            <a class="btn" href="<?php echo url('admin/article/add'); ?>">新 增</a>
...
<script type="text/javascript">
	$('.status').click(function () {
       ...
       if(val=='0')
       {
           if(confirm('是否通过认证?'))
           {
               $.getJSON('ajax_approve',{id:id},function (data) {
