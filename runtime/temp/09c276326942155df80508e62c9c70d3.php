<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"D:\PhPstudy\WWW\think2\public/../application/home/view/default/index\index.html";i:1512053135;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
...
<nav class="navbar navbar-default navbar-fixed-bottom">
    <div class="container-fluid text-center">
        ...
        <div class="col-xs-3">
            <p class="navbar-text"><a href="<?php echo url('village/service'); ?>" class="navbar-link">服务</a></p>
        </div>
        <div class="col-xs-3">
...
<div class="container-fluid">
    <div class="indexImg row">
        <img src="__ROOT__/static/new/image/index.png" width="100%" />
    </div>
    <div class="serviceList text-center">
        <div class="container">
            <div class="row">
                <div class="col-xs-4">
                    <a href="<?php echo url('village/notice','category_id=43'); ?>">
                ...
                <div class="col-xs-4">
                    <a href="<?php echo url('village/notice','category_id=45'); ?>">
                ...
                <div class="col-xs-4">
                    <a href="<?php echo url('property/online'); ?>">
                ...
                <div class="col-xs-4">
                    <a href="<?php echo url('village/notice','category_id=46'); ?>">
                ...
                <div class="col-xs-4">
                    <a href="<?php echo url('village/sale'); ?>">
                ...
                <div class="col-xs-4">
                    <a href="<?php echo url('village/village','category_id=47'); ?>">
...
<!--<script src="./home/new/jquery-1.11.2.min.js"></script>
&lt;!&ndash; Include all compiled plugins (below), or include individual files as needed &ndash;&gt;
<script src="./home/new/bootstrap/js/bootstrap.min.js"></script>-->
</body>
</html>