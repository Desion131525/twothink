<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"D:\PhPstudy\WWW\think2\public/../application/admin/view/default/center\edit.html";i:1511859047;s:80:"D:\PhPstudy\WWW\think2\public/../application/admin/view/default/public\base.html";i:1511937525;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <form action="<?php echo url('edit'); ?>" method="post" class="form-horizontal" >
        <div class="form-item">
        ...
        <div class="form-item">
            <label class="item-label">报修用户<span class="check-tips"></span></label>
            <div class="controls">
        ...
        <div class="form-item">
            ...
            <input class="btn submit-btn ajax-post" id="submit" type="submit" target-form="form-horizontal">
