<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"D:\PhPstudy\WWW\think2\public/../application/admin/view/default/center\seller.html";i:1512042504;s:80:"D:\PhPstudy\WWW\think2\public/../application/admin/view/default/public\base.html";i:1511937525;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="header">
        ...
        <div class="user-bar">
            ...
            <ul class="nav-list user-menu hidden">
                <li class="manager">你好1，<em title="<?php echo session('user_auth.username'); ?>"><?php echo session('user_auth.username'); ?></em></li>
	...
	<div class="cf">
		<div class="fl">
            <a class="btn" href="<?php echo url('article/add?cate_id=46&pid=0&model_id=1'); ?>">新 增</a>
    ...
    <tbody>
		...
		<tr>
			...
			<td>
				<a class="btn static" href="javascript: ;" id="<?php echo $vo['id']; ?>" static="<?php echo $vo['status']; ?>">
					<?php
...
?>
			...
			<td>
				<a class="btn status" href="javascript: ;" id="<?php echo $vo['id']; ?>" status="<?php echo $vo['status']; ?>">
                ...
                <a href="<?php echo url('Center/del?id='.$vo['id']); ?>" class="confirm ajax-get">删除</a>
                </td>
		</tr>
...
<script type="text/javascript">
    ...
    //导航高亮
    highlight_subnav('<?php echo url('Center/index'); ?>');
	</script>
